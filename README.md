...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xhistogram-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7152&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xhistogram-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xhistogram` can be installed with:

```
conda install xhistogram
```

It is possible to list all of the versions of `xhistogram` available on your platform with:
